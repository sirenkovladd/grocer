...
func (x *Receipt) GetTotalCents() int64 {
	if x != nil {
		return x.TotalCents
	}
	return 0
...
func (x *ReceiptItem) GetUnitPriceCents() int64 {
	if x != nil {
...
func (x *Proposal) GetTotalCents() int64 {
	if x != nil {
		return x.TotalCents
	}
	return 0
...
func (x *ProposalItem) GetUnitPriceCents() int64 {
	if x != nil {
		return x.UnitPriceCents
	}
	return 0
...
type Snapshot struct {
	...
	BotUsers      []*BotUser             `protobuf:"bytes,7,rep,name=botUsers,proto3" json:"botUsers,omitempty"`
...
func (x *Snapshot) GetBotUsers() []*BotUser {
	if x != nil {
		return x.BotUsers
	}
	return nil
...
func (x *Snapshot) GetSessions() []*Session {
	if x != nil {
		return x.Sessions
	}
	return nil
...
const file_proto_grocer_proto_rawDesc = "" +
	...
	"normalized\x12\x18\n" +
	"\aaliases\x18\x06 \x03(\tR\aaliases\"\xdc\x01\n" +
	"\aReceipt\x12\x1c\n" +
	...
	"\x05items\x18\x06 \x03(\v2\x13.grocer.ReceiptItemR\x05items\x12\x1e\n" +
	"\n" +
	...
	"\x04date\x18\x04 \x01(\x06R\x04date\x12\x1a\n" +
	"\bphotoUrl\x18\x05 \x01(\tR\bphotoUrl\x12*\n" +
	"\x05items\x18\x06 \x03(\v2\x14.grocer.ProposalItemR\x05items\x12\x1e\n" +
	"\n" +
	"totalCents\x18\a \x01(\x03R\n" +
	"totalCents\x12\x16\n" +
	...
	"\tproposals\x18\x06 \x03(\v2\x10.grocer.ProposalR\tproposals\x12+\n" +
	"\bbotUsers\x18\a \x03(\v2\x0f.grocer.BotUserR\bbotUsers\x12+\n" +
	"\bsessions\x18\b \x03(\v2\x0f.grocer.SessionR\bsessions\"]\n" +
	"\aSession\x12\x1c\n" +
	"\tsessionId\x18\x01 \x01(\x06R\tsessionId\x12\x1c\n" +
	"\ttokenHash\x18\x02 \x01(\tR\ttokenHash\x12\x16\n" +
	"\x06userId\x18\x03 \x01(\x06R\x06userId\"A\n" +
	"\aBotUser\x12\x1e\n" +
	"\n" +
...
var file_proto_grocer_proto_depIdxs = []int32{
	...
	10, // 8: grocer.Snapshot.botUsers:type_name -> grocer.BotUser
	9,  // 9: grocer.Snapshot.sessions:type_name -> grocer.Session
